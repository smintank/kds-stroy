...
PHONE_MIN_LENGTH_ERROR_MSG = "Номер телефона должен содержать " \
                             "не меньше 11 цифр"
PHONE_MAX_LENGTH_ERROR_MSG = "Номер телефона должен содержать " \
                             "не больше 11 цифр"
...
PHOTO_DUPLICATE_ERROR_MSG = "{} - является дубликатом другого загружаемого " \
                            "файла"
